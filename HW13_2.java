...
public class HW13_2 {
    ...
    static class DeadLockThread implements Runnable {
        ...
        @Override
        public void run() {
            System.out.println("Thread number" + threadNumber + ": starting");
            while(true) {
                synchronized (object1) {
                    System.out.println("Thread number" + threadNumber + " first synchronized");
                    synchronized (object2) {
                        System.out.println("Thread number" + threadNumber + " second synchronized");
                    }
                }
            }
        }
